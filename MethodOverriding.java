...
class MethodOverriding {
  public static void run() {
    ...
    System.out.println("Great! This is correct " + codeParent);
    System.out.println(
        "Now call the show() function, it should be like parent.show()");
    ...
    System.out.println("Great! This is correct " + codeChild);
    System.out.println(
        "Now run the show() function, it should be like child.show()");
    ...
    while (true) {
      System.out.println("Would you like to run your code? type yes");
